...
| **PaymentType** | [PaymentType](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/paymenttype) | The payment type for the amendment request (optional). |
| **PaymentCardInput** | [CreditCardInput](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/creditcardinput) | The credit card input for the amendment request (optional). |
