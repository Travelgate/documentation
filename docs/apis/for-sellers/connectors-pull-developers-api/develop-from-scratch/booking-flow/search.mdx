...
![Mock Example](/img/docs/connectors-pull-developers-api/MockTwoAdults.png)
...
![Response example](/img/docs/connectors-pull-developers-api/TemplateStructureModels.png)
...
![AccessModelStructure](/img/docs/connectors-pull-developers-api/AccessModel.png)
    ...
    out IEnumerable<AdviseMessage> adviseMessages)
{
    ...
    if (supplierResponseWrappers.ElementAt(0).Response.Options is null)
    {
        adviseMessages =
        [
...
![Build Request Search](/img/docs/connectors-pull-developers-api/BuildRequestSearch.png)
...
![Build Buyer's Response](/img/docs/connectors-pull-developers-api/BuildBuyersResponseSearch.png)
