...
using Connectors.Pull.Hotel.Domain.Contracts.CheckBookingsByDate.Response;
using ConnectorsIntegration.CheckBookingsByDate.Models.Response;
...
internal partial class CheckBookingsByDateOperation
{
    public CheckBookingsByDateConnectorResponse ParseResponses(
        ...
        CheckBookingsByDateParameters<AccessModel> connectorParameters,
        IEnumerable<SupplierResponseWrapper<CheckBookingsByDateResponse>> supplierResponses,
        CheckBookingsByDatelationToken checkBookingsByDatelationToken)
    {
    ...
    private CheckBookingsByDateRs ParseSupplierResponse( CheckBookingsByDateResponse supplierResponse)
    {
