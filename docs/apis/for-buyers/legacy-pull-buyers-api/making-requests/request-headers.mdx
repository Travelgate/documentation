...
2. Every time you create a new client on the Travelgate website under Connections > [API Settings](https://app.travelgatex.com/connections/settings), In this [section](https://docs.travelgate.com/kb/platform/app-features/connections/api-settings/) you can find documentation on the use of API settings. 
