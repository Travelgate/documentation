...
1. **Organization/Group Level**: Settings at this level apply to the entire organization or Hotel-X group. You can adjust these organization or group settings at the [API Settings](/kb/connections/connections-settings) section on our website.
