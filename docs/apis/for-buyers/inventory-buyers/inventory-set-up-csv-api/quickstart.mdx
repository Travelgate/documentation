...
#### Data Validation
As you fill the spreadsheet, the script automatically checks all required fields and format rules. Invalid cells are highlighted in **red** with a description of the error. Run **✅ Validate All Sheets** at any time to see a full error summary.
...
#### CSV Export
Use **📥 Export CSV** to generate correctly formatted CSV files (semicolon-delimited, UTF-8) ready for SFTP upload. The tool names the files automatically using your Client Code and Supplier Code.
