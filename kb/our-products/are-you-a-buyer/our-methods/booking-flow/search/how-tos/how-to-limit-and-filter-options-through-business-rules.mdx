...
1. **ROOM_TYPE**: It groups the option by room type without exceeding the optionsQuota limit.
	...
	![limit_and_filter_1](https://storage.travelgate.com/kbase/limit_and_filter_1.jpg)
...
![limit_and_filter_2](https://storage.travelgate.com/kbase/limit_and_filter_2.jpg)
