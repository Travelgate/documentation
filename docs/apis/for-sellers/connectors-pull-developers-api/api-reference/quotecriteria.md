...
| **Occupancies** | Array&lt;[Occupancy](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/occupancy)&gt; | Details about the occupancy for the Quote request, including rooms, passengers, and their ages. |
...
| **Rooms** | Array&lt;[Room](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/room)&gt; | List of selected rooms for the Quote request. |
...
| **FromBookCriteria/CancelPolicy** | [CancelPolicy](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/cancelpolicy) | Specifies the cancellation policy associated with the booking. |
