...
You need to have an agreement with a VCC supplier integrated with TravelgateX to start using this plugin. Please check our [VCC Payments article](/kb/faqs/faqs-price/vcc-payments) to learn all the steps before configuring the plugin in your book mutations.
:::
