...
The [AccumulativeRoom](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/accumulativeroom) object represents the standardized structure of the mapped room element.
...
| **Names** | Dictionary&lt;[Iso2LanguageEnum](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/iso2languageenum), String&gt; | **[Deprecated]** This field is deprecated. Use `Descriptions` instead. Gets or sets the names of the room in different languages. |
