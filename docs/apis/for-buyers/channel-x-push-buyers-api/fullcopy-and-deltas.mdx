...
Once you have your system configured to handle our Availability, Rate Plans, and Inventory (ARI) requests, and both you have completed the setup of the hotel, rates, and rooms, while the Seller has pushed availability and rates to inventory; you will need to perform a Full Copy to load the products into your system. 
...
<details>
    <summary>What happens if a rate is deleted, does TravelgateX inform us of this in the Full Copy?</summary>
    <div>
