...
**Using the HotelX API, you will be able to access static information, make bookings, and manage reservations.** In this quickstart tutorial, you will learn how to create a simple sample booking.
