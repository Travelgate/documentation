...
### **Configuration**
Once downloaded, create a file named `appsettings.connectors.local.json` in the project `Travelgate.Pull.Hotel.Formtest.Connectors`.
...
### **Profiles**
To add predefined configurations, modify the `profiles.json` file located in the `Travelgate.Pull.Hotel.Formtest` project.
...
![FormTest Initial Run](/img/docs/connectors-pull-developers-api/formtest_run.png)
...
![Search Example](/img/docs/connectors-pull-developers-api/formtest_search.png)
...
![Option Selection](/img/docs/connectors-pull-developers-api/formtest_search_option_selected.png)
...
![Reservation Tab](/img/docs/connectors-pull-developers-api/formtest_book.png)
...
![Manage Tab](/img/docs/connectors-pull-developers-api/formtest_manage.png)
