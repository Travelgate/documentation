...
This operation is designed for the comprehensive retrieval of full **HotelDetails** static data. This operation should be used when hotel information can be retrieved using the hotel code previously retrieved in HotelList.
