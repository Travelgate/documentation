...
:::warning
Please note that amendments are not available for all suppliers. To verify whether your supplier allows modifications, please refer to the [metadata](/docs/for-buyers/hotel-x-pull-buyers-api/content/metadata) configuration.
:::
