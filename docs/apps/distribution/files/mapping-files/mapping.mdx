...
If you are a DMC and only plan to sell your own product, which you added to the [Inventory extranet](https://inventory.xmltravelgate.com/Account/Login?ReturnUrl=%2f) before, you will need to add the same code in both Seller and Buyer.
