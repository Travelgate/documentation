...
| --- | --- | --- |
| **ComunicationStatus** | The technical health of the connection between Travelgate and the Seller. This legacy spelling is intentional and matches the API response field name. | - OK: The communication with the Seller was successful.&nbsp;<br />  - KO: Connection established but failed.&nbsp;<br />  - OFFLINE: Seller system unreachable. |
