...
Your searches will use the blacklist rules you create on our website in the **[Plugins](https://app.travelgate.com/connections/plugins)** section. In this section, under the **Blacklist** tab, you’ll be able to view, create, and update your rules. A rule is a set of parameters that define both a configuration and a result.

In the blacklist rule configuration, you must always specify the following:

* **IdRule:** Unique identifier of the rule. You can assign any identifier that best suits you.
* **Clients, Suppliers and Accesses:** List of client, supplier, and access codes to which you want the rule to apply.
* **Context:** Buyer context code to which you want the rule to apply.

The result of the rule is made up of hotels or countries:

* **Country:** Country code to be blacklisted.
* **Hotels:** List of hotel codes to be blacklisted.


## Optional: Create and Upload your Blacklist File

You can also create your Blacklist Rules uploading a file to our FTP server instead of using our website.
