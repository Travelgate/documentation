...
Upon receiving your Onboarding Welcome Pack, you will be granted access credentials to the FTP server. In the event that you need assistance or have not received your credentials, kindly open a [ticket](https://app.travelgate.com/support) to our Customer Care team to obtain your FTP credentials and initiate your journey.
