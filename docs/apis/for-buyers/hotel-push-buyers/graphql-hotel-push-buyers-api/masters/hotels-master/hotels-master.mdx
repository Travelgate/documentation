...
import {hotelsMasterQuery, hotelsMasterByHotelCodesVariables, hotelsMasterByContextCodeVariables, hotelsMasterByCountryCodeVariables, hotelsMasterByLocalityIdVariables} from "/src/graphql/inventory-push/master/hotels-master.query";
