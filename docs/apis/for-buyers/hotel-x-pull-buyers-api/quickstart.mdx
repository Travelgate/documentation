...
import {quoteQuickStartQuery} from "../../../../src/graphql/sample-queries/quote.quickstart.query";
import {bookQuickStartMutation} from "../../../../src/graphql/sample-queries/book.quickstart.mutation";
...
<GraphqlSample query={searchQuickStartQuery} variables={'{"foo": "bar"}'}/>
...
<GraphqlSample query={quoteQuickStartQuery} />
...
<GraphqlSample query={bookQuickStartMutation} />
