...
Define the responses for your operation, it is recommended to insert a supplier response into every mock or at least, into the mocks of the operation you will be developing.
