...
When creating your quote query, you have three different inputs to fill based on your specific needs:
...
To specify your filters you need to use the input `HotelXFilterInput` in your query variables. The available filter in quote is:
