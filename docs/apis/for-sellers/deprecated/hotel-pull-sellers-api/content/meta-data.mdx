...
After each request, you will have to process the data and provide a response. Upon receiving a `MetaData` request, you will need to send a corresponding `MetaData` response.
...
<MetaDataRS>
   ...
   <Avail>
      ...
      <MaxRelease reviewDate = "20/06/2022">9999</MaxRelease>
...
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
| Avail/Release                                       | 1          | Integer | Minimum days required in between booking date and checking date ( days in advance ). If the value is zero then there is no limitation. If the value is -1, buyers are allowed to make reservations for the day before the check-in. Useful in edge cases where the supplier's timezone is ahead.    |
| Avail/MaxRelease                                    | 1          | Integer | Maximum days required in between booking date and checking date ( days in advance ).                                                       |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
...
| RoomCandidates/MaxPaxInRoomCandidates               | 1          | Integer | Maximum number paxes in same room that can be requested in the same avail request.                                                          |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
| RoomCandidates/MaxPaxInAllRooms                     | 1          | Integer | Total amount of paxes that can be requested in the same avail request.                                                                      |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
...
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
| Reservation/AllowsUrlCard                           | 1          | Boolean | Specifies if the supplier allows url card data encode when the payment type is LaterPay.                                                  |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
