...
![Template Structure Models Boards](/img/docs/connectors-pull-developers-api/TemplateStructureModelsBoards.png)
...
![TryValidateBoards](/img/docs/connectors-pull-developers-api/BoardsOperation.png)
...
![Build Request Boards](/img/docs/connectors-pull-developers-api/BoardsBuildRequest.png)
...
![Build Buyer's Response](/img/docs/connectors-pull-developers-api/BoardsParseResponse.png)
