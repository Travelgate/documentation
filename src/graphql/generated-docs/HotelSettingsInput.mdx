...
we apply the same configuration to all Hotel-X clients in our back system.  
    ...
    <details>
      <summary>
      **suppliers**&nbsp;<span class="required"> *</span>&nbsp; (*HotelXSupplierInput*)  
...
This information is mandatory.  
      ...
      <details>
        <summary>
        **accesses**&nbsp;<span class="required"> *</span>&nbsp; (*HotelXAccessInput*)  
...
overwrite it. Acts as an identifier in this search. It can either exist or not.  
        ...
        <details>
          ...
          **configuration** (*ConfigurationInput*)  
          ...
          <details>
            <summary>
            **parameters**&nbsp;<span class="required"> *</span>&nbsp; (*ParameterInput*)  
...
This information is mandatory.  
    ...
    <details>
      <summary>
      **plugins**&nbsp;<span class="required"> *</span>&nbsp; (*PluginStepInput*)  
      ...
      <details>
        <summary>
        **pluginsType**&nbsp;<span class="required"> *</span>&nbsp; (*PluginsInput*)  
        Indicates the plugin that will be executed.  
        </summary>
  
        <details style={{ pointerEvents: "none" }}>
          <summary>
          **type**&nbsp;<span class="required"> *</span>&nbsp; (*Enum of PluginType*)  
        ...
        <details style={{ pointerEvents: "none" }}>
          <summary>
          **parameters**&nbsp;<span class="required"> *</span>&nbsp; (*undefined*)  
    ...
    <details style={{ pointerEvents: "none" }}>
      <summary>
      **clientTokens**&nbsp;<span class="required"> *</span>&nbsp; (*String*)  
