...
<details>
    ...
    <div>
        <div>If the seller provides cancel policies information, you can access it either through the HotelX Quote Query or, if the reservation has already been made, with the HotelX Booking Query.</div>
    </div>
</details>

:::tip
For practical guidance on cancellation edge cases, partial room cancellations, and common issues, visit our [Cancel FAQs](/kb/connectivity-products/for-buyers/hotel-x/booking-management/cancel/faqs) in the Knowledge Base. 🚀
:::