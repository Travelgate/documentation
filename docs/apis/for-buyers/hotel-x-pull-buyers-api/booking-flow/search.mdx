...
* `rateRule`
* `cancelPolicy`
* [`id`](/kb/our-products/are-you-a-buyer/getting-started-with-hotel-x-buyers-api/understanding-the-id-optionRefId-of-an-option)
...
Additionally, you  receive a warning for those options we couldn't return, as [the supplier does not provide the commission through the API](/kb/our-products/are-you-a-buyer/our-methods/lists-of-errors-and-warnings/wrong-field-plugin-error). 
