...
<details>
  <summary>
    <strong>InventoryRoomsSetupCreateInput</strong> <em>(INPUT_OBJECT)</em>
  </summary>
  ...
  <details>
    <summary>
      <strong>rooms</strong>&nbsp;<span class="required"> *</span>&nbsp; <em>(InventoryRoomSetupInput)</em>
    </summary>
    Rooms input data.
    ...
    <details style={{ pointerEvents: "none" }}>
      <summary>
        <strong>masterCode</strong>&nbsp;<span class="required"> *</span>&nbsp; <em>(String)</em>
      </summary>
    ...
    <details>
      <summary>
        <strong>uses</strong>&nbsp;<span class="required"> *</span>&nbsp; <em>(InventoryRoomUseInput)</em>
      </summary>
