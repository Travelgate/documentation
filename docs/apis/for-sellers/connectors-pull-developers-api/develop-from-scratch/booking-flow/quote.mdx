...
:::caution
If your seller's workflow does not include a Quote step, proceed directly to the [Repeat Operations](../../connector-framework/repeat-flow-operations.mdx) section to repeat the Search operation.
:::
...
![Mock Example](/img/docs/connectors-pull-developers-api/MockTwoAdultsQuote.png)
...
![Response example](/img/docs/connectors-pull-developers-api/TemplateStructureModelsQuote.png)
...
```
File location: "**ConnectorsIntegration\Quote\Models\Request\QuoteRequest.cs**"
...
```csharp
internal partial class QuoteOperation : IQuoteOperation<QuoteRequest, QuoteResponse, AccessModel>
{
...
![TryValidateSearch](/img/docs/connectors-pull-developers-api/TryValidateSearch.png)
    ...
    out IEnumerable<AdviseMessage> adviseMessages)
{
    ...
    if (supplierResponseWrappers.ElementAt(0).Response.Option is null)
    {
        adviseMessages =
        [
            AdviseMessage.BuildOptionNotFoundInQuote // Indicates option was not found in the supplier system.
        ];
...
![Build Request Quote](/img/docs/connectors-pull-developers-api/BuildRequestQuote.png)
...
![Build Response Quote](/img/docs/connectors-pull-developers-api/ParseResponseQuote.png)
...
internal partial class QuoteOperation
{
    ...
    private QuoteRs ParseSupplierResponse(QuoteConnectorRequest connectorsRequest, QuoteResponse supplierResponse)
    {
        ...
        {
            List<AdviseMessage> adviseMessages = new(){AdviseMessage.BuildOptionNotFoundInQuote()};
            return QuoteRs.BuildErrorResponse(adviseMessages);
        }
