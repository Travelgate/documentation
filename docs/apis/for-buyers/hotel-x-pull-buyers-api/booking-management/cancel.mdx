...
Filters allow you to precisely tailor the response according to your preferences. To specify your filters you need to use the input `HotelXFilterInput` in your mutation variables. The available filter in cancel is:
