...
# Essential Tech Requirements Before Connecting with Travelgate as a Buyer

### Preparing for Hotel-X API Development: Key Considerations Before Embarking on Development Work

**Welcome aboard to Travelgate!**
...
Travelgate is purely focused on connectivity so to be able to work with us via API and make the most of our Platform, you should ensure the following solutions are set up, whether in-house or outsourced:
