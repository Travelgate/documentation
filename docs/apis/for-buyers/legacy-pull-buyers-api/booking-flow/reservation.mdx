...
| ReservationRQ/Remarks       				| 0..1    	| 		| Any customer comments for the supplier to consider (see [MetaData](../content/meta-data/) in order to verify if the supplier implements it).	|
