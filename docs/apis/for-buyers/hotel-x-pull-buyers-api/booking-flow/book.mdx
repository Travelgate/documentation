...
* `paymentCard` (If the payment is done by credit card, it's mandatory to specify the payment type and the credit card information, unless you're using our VCC Plugin to generate virtual credit cards. Know more about VCC payments [here](/kb/our-products/are-you-a-buyer/getting-started-as-a-new-buyer/how-to-activate-vcc-payments).)
...
Explore all the book output fields and their descriptions in our detailed Graphql API Reference section [here](/api/types/objects/hotel-book-payload/).
:::
