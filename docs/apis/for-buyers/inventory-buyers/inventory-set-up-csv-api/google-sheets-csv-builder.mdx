...
| `⚠️ SOSPECHOSO (Suspicious) — Code looks invalid` | A code cell contains a corrupted or placeholder value (e.g. `##########`, `{HotelCode}`, `----`) | Replace it with the actual code. These cells are highlighted in **orange**. |
