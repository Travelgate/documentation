...
| @BookingLimit                               | 0..1 | Integer | The number of rooms available per Room-RatePlan for the specified dates. In the case of Derived Rates this element will not be returned.                                                                                                                                     |
