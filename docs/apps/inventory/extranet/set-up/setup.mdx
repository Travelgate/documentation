...
1. **All room types:** Select from the autocomplete field a room code and description from your own room master list.
...
* **Code:** Room code. Must be unique per rate and has to coincide with the code used by the channel.  
  :::caution
  Once the room is created, the **Code** field cannot be edited.
  :::
