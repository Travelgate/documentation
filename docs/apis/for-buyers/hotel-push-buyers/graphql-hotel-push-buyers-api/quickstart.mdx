...
- Explore the [Making Requests](../graphql-hotel-push-buyers-api/making-requests/endpoint) section to dive deep into how a GraphQL API works and maximize its performance.
- Discover various queries and mutations grouped by the following actions:
    - [Masters](../graphql-hotel-push-buyers-api/masters/overview): Explore or store static data in Inventory.
    - [SetUp](../graphql-hotel-push-buyers-api/setUp/overview): Learn how to completely set up your product in Inventory.