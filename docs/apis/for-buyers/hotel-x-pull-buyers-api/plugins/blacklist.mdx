...
* **Change the priority of the rule:** Rules are processed in numerical order, meaning priority '0' is executed first. Therefore, the lower the number, the higher the priority.
