...
| @SellThroughOpenIndicator                   | 0..1 | Boolean | Room-RatePlan can be sold with no limit (Free Sales) if @Status is 'Open'. This field is exclusively used for Basic Rates.                                                                                                                                                                       |
