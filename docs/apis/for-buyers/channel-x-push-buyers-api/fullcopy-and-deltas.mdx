...
Once you have your system configured to handle our Availability, Rates, and Inventory (ARI) requests, and both you have completed the setup of the hotel, rates, and rooms, while the Seller has pushed availability and rates to inventory; you will need to perform a Full Copy to load the products into your system. 
