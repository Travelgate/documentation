...
[Here](/api/types/enums/comparison-field/) you can find all the possible fields that you can exclude from our internal comparison when searching for the option to quote.
