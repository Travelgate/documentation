...
/* harmony import */ var _show_hint_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17128);
/* harmony import */ var graphql_language_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5984);
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("hint", "graphql", (o, a) => {
  ...
  if (!i)
    return;
  const s = o.getCursor(), e = o.getTokenAt(s), l = e.type !== null && /"|\w/.test(e.string[0]) ? e.start : e.end, p = new graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .Position */ .JC(s.line, l), t = {
    list: (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .getAutocompleteSuggestions */ .SQ)(i, o.getValue(), p, e, c).map((n) => ({
      text: n.label,
      type: n.type,
