...
/* harmony export */   b: () => (/* binding */ getArgumentReference),
/* harmony export */   c: () => (/* binding */ getEnumValueReference),
/* harmony export */   d: () => (/* binding */ getTypeReference),
/* harmony export */   e: () => (/* binding */ getDirectiveReference),
/* harmony export */   g: () => (/* binding */ getTypeInfo)
/* harmony export */ });
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98368);
...
function getTypeInfo(schema, tokenState) {
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_0__.f)(tokenState, (state) => {
    var _a, _b;
    switch (state.kind) {
      case "Query":
      case "ShortQuery":
      ...
      case "AliasedField":
        ...
        break;
      case "SelectionSet":
        info.parentType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .getNamedType */ .MR)(info.type) : null;
        break;
      case "Directive":
      ...
      case "Argument":
        ...
        break;
      case "EnumValue":
        const enumType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .getNamedType */ .MR)(info.inputType) : null;
        info.enumValue = enumType instanceof graphql__WEBPACK_IMPORTED_MODULE_1__/* .GraphQLEnumType */ .Zb ? find(enumType.getValues(), (val) => val.value === state.name) : null;
        break;
      case "ListValue":
        const nullableType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .getNullableType */ .yl)(info.inputType) : null;
        info.inputType = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_1__/* .GraphQLList */ .KT ? nullableType.ofType : null;
        break;
      case "ObjectValue":
        const objectType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .getNamedType */ .MR)(info.inputType) : null;
        info.objectFieldDefs = objectType instanceof graphql__WEBPACK_IMPORTED_MODULE_1__/* .GraphQLInputObjectType */ .zP ? objectType.getFields() : null;
        break;
      case "ObjectField":
...
function getFieldDef(schema, type, fieldName) {
  if (fieldName === graphql__WEBPACK_IMPORTED_MODULE_2__/* .SchemaMetaFieldDef */ .S0.name && schema.getQueryType() === type) {
    return graphql__WEBPACK_IMPORTED_MODULE_2__/* .SchemaMetaFieldDef */ .S0;
  }
  if (fieldName === graphql__WEBPACK_IMPORTED_MODULE_2__/* .TypeMetaFieldDef */ .Xe.name && schema.getQueryType() === type) {
    return graphql__WEBPACK_IMPORTED_MODULE_2__/* .TypeMetaFieldDef */ .Xe;
  }
  if (fieldName === graphql__WEBPACK_IMPORTED_MODULE_2__/* .TypeNameMetaFieldDef */ .of.name && (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .isCompositeType */ .ML)(type)) {
...
function getEnumValueReference(typeInfo) {
  return {
    ...
    type: typeInfo.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_1__/* .getNamedType */ .MR)(typeInfo.inputType) : void 0
  };
}
...
var codemirrorExports = (0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.r)();
const CodeMirror = /* @__PURE__ */ (0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.g)(codemirrorExports);
...
/* harmony export */   r: () => (/* binding */ requireCodemirror)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(98368);
/* harmony import */ var _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43338);
/* harmony import */ var _SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89654);
/* harmony import */ var _info_addon_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46681);
...
function renderDirective(into, typeInfo, options) {
  ...
  text(into, name, "directive-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.e)(typeInfo));
}
function renderArg(into, typeInfo, options) {
  var _a;
  const name = ((_a = typeInfo.argDef) === null || _a === void 0 ? void 0 : _a.name) || "";
  text(into, name, "arg-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.b)(typeInfo));
...
function renderEnumValue(into, typeInfo, options) {
  ...
  text(into, ".");
  text(into, name, "enum-value", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.c)(typeInfo));
}
function renderTypeAnnotation(into, typeInfo, options, t) {
  const typeSpan = document.createElement("span");
  typeSpan.className = "type-name-pill";
  if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLNonNull */ .Gc) {
    renderType(typeSpan, typeInfo, options, t.ofType);
    text(typeSpan, "!");
  } else if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLList */ .KT) {
    text(typeSpan, "[");
    renderType(typeSpan, typeInfo, options, t.ofType);
    text(typeSpan, "]");
  } else {
    text(typeSpan, (t === null || t === void 0 ? void 0 : t.name) || "", "type-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.d)(typeInfo, t));
  }
...
function renderType(into, typeInfo, options, t) {
  if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLNonNull */ .Gc) {
    ...
    text(into, (t === null || t === void 0 ? void 0 : t.name) || "", "type-name", options, (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_2__.d)(typeInfo, t));
  }
}
