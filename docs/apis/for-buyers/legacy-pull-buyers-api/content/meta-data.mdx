...
The MetaData method returns a clear and summarized view of the Seller's main characteristics, as well as the methods implemented through their integration and the limitations and restrictions associated with their connection. The returned fields include:
...
* `TimeZone`
* `AllowsDeltaPrice`
* `AllowsProvideLocator `
* `InformCancelPolicies`
* `InformPropertyReservationNumber`
* `RequiredNationality`
...
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
| Valuation/TimeZone                                  | 1          | Enum    | Informs in which TimeZone are the hoursBefore of cancelation policies.                                              |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
...
| Preference/PreferenceType                           | 1          | String  | Type of preference allowed.                                                                       |
