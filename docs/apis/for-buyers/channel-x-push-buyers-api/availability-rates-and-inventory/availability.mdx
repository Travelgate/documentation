...
<details>
    <summary>Is there a default maximum nights restriction (e.g., max 30 days) in TravelgateX if the HotelAvailNotif does not include maximum LengthOfStay (LOS) information?</summary>
    <div>
        <div>TravelgateX does not have any restriction on default maximum nights.</div>
    </div>
</details>
