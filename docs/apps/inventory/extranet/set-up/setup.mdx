...
The occupancy area only shows a predefined set of the most common occupancy combinations. When a room or apartment accepts an occupancy that is not displayed by default (for example, larger residences for 7 to 10 people), you can add it manually with the **Create new use** option.
...
3. Click **Create Use**. The new combination is added to the **Other uses** list, where it appears already ticked (selected).
