...
By combining the Hotel Push Sellers API and [Inventory Tool](../../../apps/inventory/extranet/overview), Channel Managers and Hotel Distributors can effectively **push** their products into a Travelgate database, thereby making them accessible to Travelgate Buyers.
