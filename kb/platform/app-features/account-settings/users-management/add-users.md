...
5. **Complete the sign-up process**: The new user will receive an e-mail in order to set their password and they will be able to explore our portal. Please ensure that the initial login is done using the **username and password**, not through the Google account.
...
### How to Assign a Contact User to Receive Notifications from Travelgate
 1. Log onto our [portal](https://www.travelgate.com/).
 1. Click on Settings.
