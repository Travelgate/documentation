...
| --- | --- | --- |
| **ComunicationStatus** | The technical health of the connection between Travelgate and the Seller. This uses the legacy response element spelling. | - OK: The communication with the Seller was successful.&nbsp;<br />  - KO: Connection established but failed.&nbsp;<br />  - OFFLINE: Seller system unreachable. |
