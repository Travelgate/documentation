...
In the case of the Channel-X API, Travelgate will send requests to the Buyer's system, and the Buyer will reply with either success or error. Channel-X has three main methods; you need to configure your system to manage the following requests:
