...
- **Utility**: Buyers can use the metadata to determine compatibility with their requirements before connecting to the supplier.
...
| ------- | --- | ---- | ----------- |
| Shopping | 1 | Shopping | Gets or sets the shopping element. |
| Content | 1 | Content | Gets or sets the content element. |
<!-- TABLE END -->
