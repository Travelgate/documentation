...
Distribution Rules files offer the ability to create a range of rules. In particular, through general stop sales rules, you will be able to define general stop sales by different conditions. 
