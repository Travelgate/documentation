...
The `AmendBookingRemarksSimulate` operation allows clients to add or modify special requests and remarks for an existing booking. This operation uses the client and supplier locators to identify the reservation and communicates additional instructions, preferences, or requirements directly to the hotel or service provider.

:::note
This operation simulates what would happen if you execute the [`AmendBookingRemarks`](amend-booking-remarks.mdx) operation, without actually committing the changes.
:::

The AmendBookingRemarksSimulate operation ensures:
...
```csharp
var amendBookingRemarksSimulateRq = new AmendBookingRemarksSimulateRq
{
    Input = new AmendRemarksSimulateInput
    {
...
<!-- TABLE BEGIN Connectors.Pull.Hotel.Domain.Contracts.Amendments.AmendBookingRemarks.Request.AmendBookingRemarksSimulateRq -->
| Name | Relation | Type | Description |
|------|:--------:|:----:|-------------|
| **Input** | 1 | [AmendRemarksSimulateInput](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/amendremarkssimulateinput) | Gets or initializes the input details for simulating the remarks amendment, including specific information about the booking and the new remarks. |
...
| **Input/AmendRemarks** | 1 . . N | Array&lt;[Remark](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/remark)&gt; | Gets a collection of remarks to be amended or added to the booking. Each remark contains a type and text content. |
...
The `AmendBookingRemarksSimulate` operation provides:
- **Amendment Status**:
...
var amendRs = new AmendRs
{
    ...
    BookDetails = new List<BookDetails>
    {
        new BookDetails
        {
            ...
            Price = Price.BuildNetPrice(Currency.EUR, 150.00, 180.00),
            ...
            Remarks = new List<string>
            {
                ...
                "Late check-in expected (after 11 PM)",
