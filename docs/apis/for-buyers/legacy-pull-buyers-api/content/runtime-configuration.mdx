...
The Runtime Configuration method returns a template of the supplier’s configuration. The returned fields include:
...
| Element                       | Rel  | Type     | Description                                                 |
|-------------------------------|------|----------|-------------------------------------------------------------|
| RuntimeConfigurationRS/UpgradeUTCDate | 1    | DateTime | Indicates the update date of the information in UTC format. |
| a                             | 1    |          | a                              |
| a                             | 0..n |          |                                                             |
| a                             | 1    | String   | a                                               |
| a                             | 1    | String   | a                                       |