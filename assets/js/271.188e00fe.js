...
/* harmony import */ var graphql_language_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82210);
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.defineMode("graphql-variables", (config) => {
  const parser = (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_1__/* .onlineParser */ .r5)({
...
const ParseRules = {
  ...
  Variable: [namedKey("variable"), (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_1__.p)(":"), "Value"],
  Value(token) {
    switch (token.kind) {
      case "Number":
        return "NumberValue";
  ...
  ObjectField: [namedKey("attribute"), (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_1__.p)(":"), "Value"]
};
