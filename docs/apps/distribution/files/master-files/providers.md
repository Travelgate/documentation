...
Create and update your providers.


## Create and Upload your Providers Master File

To get started, create your providers master file in the correct format and then upload it to your FTP account. We've provided a template file below ⬇️ to help you with this process. Just click on the file name, add your data, save it in CSV format, and then upload it to the corresponding folder in your FTP.
...
&nbsp;&nbsp;&nbsp;&nbsp; 📁HotelX_0000  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📁Masters  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **📄[Providers.csv](https://storage.travelgate.com/docs/Providers.csv)**  
...
* **Data:**
   ...
   * **Direct or Third Provider (mandatory)**: Boolean.
        * **True**: Direct / Own provider.
        * **False**: Third / External provider.
* **Note:**
