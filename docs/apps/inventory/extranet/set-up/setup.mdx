...
* **BusinessRules:** Business Rules in Inventory allow you to classify a rate and then control how that rate is consumed in Search/Book flows.
  ...
  To hot-change these parameters in Search (without changing the access static configuration), if you use Hotel-X Pull Buyers API, use the ["Add parameters" Hotel-X plugin](/docs/apis/for-buyers/hotel-x-pull-buyers-api/plugins/add-parameter).
  :::
