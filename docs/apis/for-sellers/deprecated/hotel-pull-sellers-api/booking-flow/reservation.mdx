...
| ReservationRQ/OnRequest     				| 1  		| Boolean	| Indicates if you want to receive the onrequest option in ReservationRS, as long as the supplier returns it in this method (see [MetaData](../content/meta-data/) in order to verify if the supplier implements it).	|
