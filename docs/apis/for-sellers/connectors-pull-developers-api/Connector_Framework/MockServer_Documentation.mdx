...
<Response>
  <error mensaje="Authentication Failed - Wrong Password"/>
</Response>
```
...
> **Note**: This use case can be particularly challenging to implement correctly due to the precise handling of cancellation policies required by the supplier. If you encounter difficulties, do not hesitate to reach out to Travelgate's support team for assistance.
