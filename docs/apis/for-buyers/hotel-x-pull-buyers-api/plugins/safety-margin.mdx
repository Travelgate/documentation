...
First, create your safety margin file in the correct format and then upload it to your FTP account. To assist you with this process, you can download the template file below ⬇️, add your own rules, save it in CSV format, and then upload it to the corresponding folder in your FTP.
...
&nbsp;&nbsp;&nbsp;&nbsp; 📁HotelX_0000  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📁BusinessRules  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📄[BuyerContext_sequential_safetymargin.csv](../../../../../static/files/hotel-x/BuyerContext_sequential_safetymargin.csv)
