...
&nbsp;&nbsp;&nbsp;&nbsp; 📁HotelX_0000  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📁BusinessRules  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📄[/[Buyer Context\]_sequential_commission.csv](../../../../../static/files/hotel-x/[Buyer Context]_sequential_commission.csv)
...
* **File Name:** [Buyer Context]_sequential_commission.csv
...
|---------------------------------------------------------------|-------------------------------|
| File for error “"WRONG_FIELD" - "PLUGIN_ERROR" - some of the options have been discarded because we don't know if price is gross or net” | 📄[/[Buyer Context\]\_sequential\_commision.csv](../../../../../static/files/hotel-x/[Buyer Context]_sequential_commission - 1.csv) |
