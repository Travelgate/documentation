...
In the hotel list, each hotel row displays the **Hotel ID**, the **Hotel Code** (in parentheses, if assigned), the **Hotel Name**, and the **City**. For example: `98716 (98716) - Hotel Antar (Bechar)`.
