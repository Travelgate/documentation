...
Make sure to include all the individuals who require access to our network by following these [instructions](https://knowledge.travelgate.com/add-user-to-account). It is important to note that the members you add may have access to sensitive information, such as your TravelgateX credentials or invoices, depending on the role assigned to them.

### Step 2: Update Your Profile✔️
To make the most out of your experience with our Partners, take a moment to [update your Profile](https://knowledge.travelgate.com/customize-profile). Your Profile serves as your introduction to our Network, and a polished profile can create even greater opportunities for you.
...
1. **Hotel-X Pull Buyers API🚀**
	...
	- **Apikey🔎**  
	Your Apikey is a unique id that identifies you. It will be the same for every Seller, Client, and for both testing and live environments.

	To find it, simply log onto our website and access our "Connections" menu. Then, select "Connection Settings":

	![associate_platform_quickguide_1](https://storage.travelgate.com/kbase/associate_platform_quickguide_1.jpg)
	
	In the "Connection Settings" section, you'll find your Apikey under "API Settings":

	![associate_platform_quickguide_2](https://storage.travelgate.com/kbase/associate_platform_quickguide_2.jpg)

	For further details, check out our "Hotel-X Credentials" [article](https://knowledge.travelgate.com/hotel-x-credentials).
...
1. **Legacy Pull Buyers API🚀**
	...
	You can create as many Hubusers and Passwords as the number of Customers you work with; there are no restrictions.

	:::warning Important:
	Remember, when making requests through the Legacy API, use the Hubuser and Password associated with the Customer who made the request on your end.
	:::

### Step 4: Activate new Sellers✔️
Now, let's start by requesting connections. Just follow these easy [steps](https://knowledge.travelgate.com/auto-activations-quickguide) to send your activation requests.
