...
**📄[Price per Room](https://storage.travelgate.com/docs/PricePerRoomMealPlanSupplementsHotelRatePlanNotif)**  
**📄[Price per Standard Occupancy](https://storage.travelgate.com/docs/OcupacionStandarHotelRatePlanNotif)**  
**📄[Price per Occupancy](https://storage.travelgate.com/docs/PricePerOcupacionHotelRatePlanNotif)**  
**📄[Derived Rate](https://storage.travelgate.com/docs/DerivedRateHotelRatePlanNotif)**  
        ...
        <HotelRatePlanNotifResponse xmlns="http://schemas.xmltravelgate.com/hubpush/provider/2012/10">
            <HotelRatePlanNotifResult Version="0" TransactionIdentifier="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx">
                <Errors xmlns="http://www.opentravel.org/OTA/2003/05">
                    <Error ShortText="Validation error" Code="-1" Language="en">Invalid MinLOS/MaxLOS: 30/1</Error>
                </Errors>
            </HotelRatePlanNotifResult>
        </HotelRatePlanNotifResponse>
    </s:Body>
