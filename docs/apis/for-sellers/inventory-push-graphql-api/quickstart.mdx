...
This seller guide focuses on **Push** integrations for generic supplier developments. The Push integration type is the primary approach for this API, where your system proactively sends updates to Travelgate's Inventory.
...
Once the setup is ready in Inventory, the booking flow in Push integrations works as follows: **Inventory manages the booking lifecycle**. Your integration should process booking notifications from Inventory, or retrieve bookings from Inventory, to keep your platform synchronized. Keep in mind that booking notifications support all payment types, while retrieve works only with Merchant payment.
