...
You can **edit or delete** the rule at any time, or even **assign it a higher priority** than other existing rules. Rules are processed in numerical order, meaning priority '0' is executed first. Therefore, the lower the number, the higher the priority.
