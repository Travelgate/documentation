...
To connect safely with Hybrid integrations, we strongly recommend implementing [One Step Quote](/docs/apis/for-buyers/hotel-x-pull-buyers-api/one-shot-booking-flow/onestepquote) or, alternatively, integrating through [HotelX Pull Buyers API Quickstart](/docs/apis/for-buyers/hotel-x-pull-buyers-api/quickstart).
:::
