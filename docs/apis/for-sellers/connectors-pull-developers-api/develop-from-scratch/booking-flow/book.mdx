...
:::caution
If a second Quote is necessary before the Book operation, consult the [Repeat Operations](../../connector-framework/repeat-flow-operations.mdx) section before developing the Book operation.
:::
...
![Mock Example](/img/docs/connectors-pull-developers-api/MockTwoAdultsBook.png)
...
![Response example](/img/docs/connectors-pull-developers-api/TemplateStructureModelsBook.png)
...
```
File location: "**ConnectorsIntegration\Book\Models\Request\BookRequest.cs**"
...
![BookOperation](/img/docs/connectors-pull-developers-api/BookOperation.png)
...
![Build Request Book](/img/docs/connectors-pull-developers-api/BuildRequestBook.png)
...
![Build Response Book](/img/docs/connectors-pull-developers-api/ParseResponseBook.png)
