...
| `useOnlyValidatedFastXCodes` | Optional       | Configurable only in the [API Settings](/kb/platform/app-features/connections/api-settings) section on the website. Default: `false`. Controls which FastX hotel and board codes are accepted in your booking flow. See [FastX code access modes](#fastx-code-access-modes) below. |
