...
If you work with HotelX Pull Buyers API and need to change values per request, use the [Add parameters plugin](/docs/apis/for-buyers/hotel-x-pull-buyers-api/plugins/add-parameter).
