...
Every FastX search response includes **FastX standardized room codes and descriptions** alongside the Supplier's native values. This provides your system with a unified room information across all connected Suppliers.
