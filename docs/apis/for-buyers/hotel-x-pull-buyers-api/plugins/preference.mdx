...
This is particularly useful when using **HotelX with FastX codes**, where multiple suppliers may offer different prices for the same hotel, board, or room type. With the Preference Plugin, you can **set preference rules** that influence how results are ranked and selected. These rules are managed through the Preference App, which is already pre-installed and ready to use for you in the "My Apps" section of the [Travelgate Store](https://app.travelgate.com/travelgate-store/discover-apps).
...
Your searches will apply the **Preference rules** you create using the Preference App. This app is already pre-installed and ready to use for you in the "[My Apps](https://app.travelgate.com/travelgate-store/my-apps)" section of the [Travelgate Store](https://app.travelgate.com/travelgate-store/discover-apps).
