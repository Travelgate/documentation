...
| Errors/Error                                 | 1    |         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| @Code                                       | 1    | String  | Error code. TravelGate defines the standardized codes listed below; when the Seller's own system returns a code, it is forwarded as-is (so you may occasionally receive codes outside this list). |
...
When the Seller has implemented the Push API, its system returns the error following the OTA standard: `@Code`, an optional `@Type`, `@ShortText` and a descriptive body. When the Seller has **not** implemented it, TravelGate standardizes the response using the error codes below (without `@Type`). This is why you may occasionally receive a `@Code` outside the standardized list, forwarded from the Seller's own system.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>1</td><td>Validation error</td></tr>
    <tr><td>10</td><td>HotelCode not found</td></tr>
    <tr><td>11</td><td>Invalid dates</td></tr>
    <tr><td>14</td><td>Invalid derived rate</td></tr>
    <tr><td>22</td><td>Rooms not found</td></tr>
    <tr><td>23</td><td>Rates not found</td></tr>
    <tr><td>30</td><td>Occupancy error</td></tr>
    <tr><td>31</td><td>RatePlan_Rate Error</td></tr>
    <tr><td>38</td><td>POS credentials not found</td></tr>
    <tr><td>50</td><td>Confirmation error</td></tr>
    <tr><td>60</td><td>Cancellation error</td></tr>
  </tbody>
</table>
</div>
</details>