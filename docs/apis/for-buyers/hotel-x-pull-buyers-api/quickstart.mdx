...
![Hotel-X Overview](../../../../static/img/docs/hotel-x/hotel-x_overview.svg)
...
If you don't have an API key yet, you will be able to test the query and mutation examples with a test API key we've added to the playground.
