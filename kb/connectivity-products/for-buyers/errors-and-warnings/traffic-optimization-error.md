...
2. **Examine and Update Criteria**
   - Assess the [Traffic Optimizer criteria](/kb/platform/app-features/smart-traffic/traffic-optimizer/traffic-optimizer-details#how-does-it-work) for the connection/access and modify it if it does not meet your needs.
