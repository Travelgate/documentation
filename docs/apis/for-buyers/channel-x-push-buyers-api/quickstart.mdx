...
- Don't forget to perform the [SetUp in the Inventory Tool](./inventory-tool/inventory-tool) before proceeding with your first [Full Copy](./fullcopy-and-deltas/fullcopy-and-deltas.mdx)!
