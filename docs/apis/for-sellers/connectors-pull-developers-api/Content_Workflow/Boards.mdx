...
The [AccumulativeBoard](/docs/apis/for-sellers/connectors-pull-developers-api/API_Reference/accumulativeboard) object represents the standardized structure of the mapped board element.
