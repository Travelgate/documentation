...
* **BusinessRules:** Business Rules in Inventory allow you to classify a rate and then control how that rate is consumed in Search/Book flows.
  ...
  To hot-change these parameters in Search (without changing the access static configuration), if you use Hotel-X Pull Buyer API, use the ["Add parameters" Hotel-X plugin](/docs/apis/for-buyers/hotel-x-pull-buyers-api/plugins/add-parameter).
  :::
...
<p>In many multi-access cases, <a href="/docs/apps/inventory/extranet/set-up/setup#how-to-add-a-rate">Business Rules</a> are also used to:</p>
<ul>
