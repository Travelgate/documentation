...
The [AccumulativeCategory](/docs/apis/for-sellers/connectors-pull-developers-api/API_Reference/accumulativecategory) object represents the standardized structure of the mapped category element.
