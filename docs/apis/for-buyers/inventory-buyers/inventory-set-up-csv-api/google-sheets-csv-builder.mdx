...
| Browser blocks multiple downloads | The first time you export, your browser may ask to "allow multiple downloads" from this site. Accept it once. |
| `#` in filename saved as `%23` | Some browsers convert the `#` character in downloaded filenames. Rename `%23` back to `#` before uploading, or download from Google Drive instead. |
