...
*baseCancelPolicy* our system automatically adds a refundable base cancellation policy with `daysBeforeArrival: 999`, `penaltyType: PERCENTAGE` and `value: 100`, so it's **non refundable**.
