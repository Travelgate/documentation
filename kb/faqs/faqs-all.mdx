...
1. [What should I check before requesting an activation of a new connection?](/kb/connections/my-connections/important-points-when-requesting-a-new-connection#what-should-i-check-before-requesting-an-activation-of-a-new-connection)
1. [How can I request an activation?](/kb/connections/my-connections/guick-guide-to-auto-activations)
1. [My access is flagged as "Not Working", what does it mean?](/kb/connections/my-connections/auto-activations-process#my-access-is-flagged-as-not-working-what-does-it-mean)
1. [As a Seller, I have been contacted regarding an activation, what should I do?](/kb/connections/my-connections/auto-activations-process#as-a-seller-i-have-been-contacted-regarding-an-activation-what-should-i-do%EF%B8%8F)
1. [My access is "Not Working" and I cannot edit it, what can I do?](/kb/connections/my-connections/auto-activations-process#my-access-is-not-working-and-i-cannot-edit-it-what-can-i-do%EF%B8%8F)
...
1. [Can we use Universally Unique Identifier Codes (UUIDs) in our mapping?](http://localhost:4200/kb/connections/connections-content/all-about-mapping#can-we-use-universally-unique-identifier-codes-uuids-in-our-mapping%EF%B8%8F)
