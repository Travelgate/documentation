...
An **API key** is a unique alphanumeric identifier used to authenticate requests to Travelgate’s APIs, such as the **HotelX Pull Buyers API**. The API key must be included in the **HTTP Authorization** header to verify the requestor’s identity and authenticate the user agent with the server.
