...
The Search query is where the adventure begins in our shopping journey! In this example, we'll explore availability for a **single hotel using its FastX code**. This hotel is offered by two different test Suppliers, so the request will include both accesses `'2'` and `'5647'`, one for each Supplier. 
...
- **Travelgate test supplier** (code: HOTELTEST)
  - **Access Code:** `2`  
  - **Available Hotel Code:** `ES284122`, `BR1518`
