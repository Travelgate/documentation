...
import {searchQuickStartQuery, searchQuickStartVariables} from "../../../../src/graphql/sample-queries/search.quickstart.query";
import {quoteQuickStartQuery, quoteQuickStartVariables} from "../../../../src/graphql/sample-queries/quote.quickstart.query";
import {bookQuickStartMutation, bookQuickStartVariables} from "../../../../src/graphql/sample-queries/book.quickstart.mutation";
...
* API Key: You can find your API Key on the Travelgate website in Connections > [Connections Settings](https://app.travelgatex.com/connections/settings).
