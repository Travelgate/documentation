...
Remember to upload your [mapping files](../plugins/overview.md) to our FTP in those cases you run requests with your own context codes, this way you will receive results from all your Sellers with your own hotel codes.
