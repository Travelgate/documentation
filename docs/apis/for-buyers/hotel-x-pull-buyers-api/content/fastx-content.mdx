...
There are two ways to obtain FastX hotel codes via HotelX API:
...
- The **GIATA code**, if you have activated [this functionality](/kb/connectivity-products/for-buyers/giata/giata-multicodes).
