...
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
| Avail/Release                                       | 1          | Integer | Minimum days required in between booking date and check-in date ( days in advance ). If the value is zero then there is no limitation. If the value is -1, Buyers are allowed to make reservations for the day before the check-in. Useful in edge cases where the supplier's timezone is ahead.    |
| Avail/MaxRelease                                    | 1          | Integer | Maximum days required in between booking date and check-in date ( days in advance ).                                                       |
| @reviewDate                                         | 1          | String  | Informs of the date when the field was last reviewed.                                                                                      |
