...
### Hotel-X Buyers API
The timeout value can be set at either the request level (in your **Settings**) or at the **Default Settings** level via our Platform under **Connections > [Connections Settings](/kb/app-features/connections/api-settings/)**.
