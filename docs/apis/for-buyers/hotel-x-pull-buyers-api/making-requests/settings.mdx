...
:::info Context Mode
Use the [Context Mode Selection](/docs/apis/for-buyers/hotel-x-pull-buyers-api/context-mode-selection) page to decide whether to use FASTX, Buyer context, or Supplier context.
:::
