...
:::info Context Mode
Use Mapping only when your integration needs Buyer-owned codes. For mode selection criteria, see [Context Mode Selection](/docs/apis/for-buyers/hotel-x-pull-buyers-api/context-mode-selection).
:::
