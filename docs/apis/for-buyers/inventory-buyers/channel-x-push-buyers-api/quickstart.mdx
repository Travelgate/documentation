...
To enable bookings, it is essential to develop [Hotel-X Pull Buyers API](/docs/apis/for-buyers/hotel-x-pull-buyers-api/quickstart.mdx) (if you already have the [Legacy Pull Buyers API](/docs/apis/for-buyers/legacy-pull-buyers-api/overview) developed, it is also possible to work with it).
