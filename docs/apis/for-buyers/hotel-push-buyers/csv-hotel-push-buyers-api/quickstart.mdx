...
* **Scenario 2:** Connecting to a Channel Manager Using TravelgateX Inventory Codes:
	...
	* **HotelCode**: Use the code from TravelgateX's inventory.   
	To check if the hotel exists in inventory you can retrieve current details using the following queries: [Hotels Master](../graphql-hotel-push-buyers-api/masters/hotels-master/), [Search Hotels Master](../graphql-hotel-push-buyers-api/masters/hotels-master/search-hotels-master)
