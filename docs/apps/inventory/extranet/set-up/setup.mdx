...
![Inventory SetUp empty form](https://storage.travelgate.com/docs/inventory_setup5.png)
...
![Inventory SetUp filled form](https://storage.travelgate.com/docs/inventory_code.png)
