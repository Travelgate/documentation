---
title: "AmendBookingRoomsSimulate"
sidebar_position: 6
---
...
:::note
This operation simulates what would happen if you execute the [`AmendBookingRooms`](amend-booking-rooms.mdx) operation, without actually committing the changes.
:::
...
<!-- TABLE BEGIN Connectors.Pull.Hotel.Domain.Contracts.Amendments.AmendBookingRooms.Request.AmendBookingRoomsSimulateRq -->
| Name | Relation | Type | Description |
|------|:--------:|:----:|-------------|
| **Input** | 1 | [AmendRoomsSimulateInput](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/amendroomssimulateinput) | Gets or initializes the input details for simulating the rooms amendment, including specific information about the booking and the new room configuration. |
...
| **Input/Rooms** | 1 . . N | Array&lt;[AmendRoom](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/amendroom)&gt; | Gets the new room configuration for the booking. |
...
| **Input/Occupancies** | 1 . . N | Array&lt;[AmendOccupancy](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/amendoccupancy)&gt; | Gets the updated occupancy information with passenger details for each room. |
