...
If you opt not to set any access at all, requests will be made to all available accesses.  
      ...
      <details style={{ pointerEvents: "none" }}>
        <summary>
        **includes**&nbsp;<span class="required"> *</span>&nbsp; (*ID*)  
      ...
      <details style={{ pointerEvents: "none" }}>
        <summary>
        **excludes**&nbsp;<span class="required"> *</span>&nbsp; (*ID*)  
    ...
    <details>
      ...
      **plugin** (*HotelXPluginFilterInput*)  
      ...
      <details>
        <summary>
        **includes**&nbsp;<span class="required"> *</span>&nbsp; (*HotelXFilterPluginTypeInput*)  
      ...
      <details style={{ pointerEvents: "none" }}>
        <summary>
        **excludes**&nbsp;<span class="required"> *</span>&nbsp; (*undefined*)  
        Plugins to exclude  
        </summary>
      </details>
    </details>
    ...
    <details>
      ...
      **rateRules** (*RateRulesFilterInput*)  
      ...
      <details style={{ pointerEvents: "none" }}>
        <summary>
        **includes**&nbsp;<span class="required"> *</span>&nbsp; (*Enum of RateRulesType*)  
    ...
    <details>
      ...
      **status** (*StatusFilterInput*)  
      ...
      <details style={{ pointerEvents: "none" }}>
        <summary>
        **includes**&nbsp;<span class="required"> *</span>&nbsp; (*Enum of StatusType*)  
