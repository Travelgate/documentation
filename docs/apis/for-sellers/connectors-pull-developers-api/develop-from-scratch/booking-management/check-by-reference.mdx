...
![Mock Example](/img/docs/connectors-pull-developers-api/MockTwoAdultsCheckBookingsByReference.png)
...
![Response example](/img/docs/connectors-pull-developers-api/TemplateStructureModelsCheckBookingsByReference.png)
...
```
File location: "**ConnectorsIntegration\CheckBookingsByReference\Models\Request\CheckBookingsByReferenceRequest.cs**".
...
![CheckBookingsByReferenceOperation](/img/docs/connectors-pull-developers-api/CheckBookingsByReferenceOperation.png)
    ...
    out IEnumerable<AdviseMessage> adviseMessages)
{
    ...
    if (supplierResponseWrappers.ElementAt(0).Response.Option is null)
    {
        adviseMessages =
        [
            AdviseMessage.BuildSupplierError() // Indicates error from the seller
        ];
...
![Build Request CheckBookingsByReference](/img/docs/connectors-pull-developers-api/BuildRequestCheckBookingsByReference.png)
...
![Build Response CheckBookingsByReference](/img/docs/connectors-pull-developers-api/ParseResponseCheckBookingsByReference.png)
