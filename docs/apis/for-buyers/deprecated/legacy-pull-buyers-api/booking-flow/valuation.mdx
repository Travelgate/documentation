...
| ValuationRQ/OnRequest                              | 1          | Boolean  | Indicates if you want to receive the on request option selected in ValuationRS, as long as the supplier returns it in this method (see [MetaData](../content/meta-data/)). |
