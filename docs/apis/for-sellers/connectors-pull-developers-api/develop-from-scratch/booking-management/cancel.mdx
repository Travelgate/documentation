...
![Mock Example](/img/docs/connectors-pull-developers-api/MockTwoAdultsCancel.png)
...
![Response example](/img/docs/connectors-pull-developers-api/TemplateStructureModelsCancel.png)
...
```
File location: "**ConnectorsIntegration\Cancel\Models\Request\CancelRequest.cs**"
...
```chsarp
internal partial class CancelOperation : ICancelOperation<CancelRequest, CancelResponse, AccessModel>
{
...
![CancelOperation](/img/docs/connectors-pull-developers-api/CancelOperation.png)
...
![Build Request Cancel](/img/docs/connectors-pull-developers-api/BuildRequestCancel.png)
...
![Build Response Cancel](/img/docs/connectors-pull-developers-api/ParseResponseCancel.png)
...
internal partial class CancelOperation
{
    ...
    private CancelRs ParseSupplierResponse(CancelResponse supplierResponse)
    {
        ...
        {
            return CancelRs.BuildErrorResponse(new[]
            {
