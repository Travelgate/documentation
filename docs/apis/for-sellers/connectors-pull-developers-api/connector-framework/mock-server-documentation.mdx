...
- **BookingFlowImplemented**: Boolean flag to indicate if booking flow are implemented.
- **Access**: Mimics the supplier's access configuration. [View Access Data](../access-data/access-data.mdx)
- **CancelPolicy**:
