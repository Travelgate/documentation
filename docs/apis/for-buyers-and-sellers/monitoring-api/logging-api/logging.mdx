...
|---|---|---|
| `buyer_in` | Buyer Organization Code | Query your Buyers list in the [Admin API](/docs/apis/for-buyers-and-sellers/admin-api/overview) to retrieve the `orgCode` |
| `seller_in` | Seller Organization Code | Query your Sellers list in the [Admin API](/docs/apis/for-buyers-and-sellers/admin-api/overview) to retrieve the `orgCode` |
| `access_in` | Access Code | Query your Connections/Accesses in the [Admin API](/docs/apis/for-buyers-and-sellers/admin-api/overview) to retrieve the `code` |
...
|---|---|---|---|
| `buyer` (scalar `String`) | `buyer_in` (array of `String`) | Buyer Organization Code | Query your Buyers list in the [Admin API](/docs/apis/for-buyers-and-sellers/admin-api/overview) to retrieve the `orgCode` |
| `seller` (scalar `String`) | `seller_in` (array of `String`) | Seller Organization Code | Query your Sellers list in the [Admin API](/docs/apis/for-buyers-and-sellers/admin-api/overview) to retrieve the `orgCode` |
