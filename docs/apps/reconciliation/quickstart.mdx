...
:::warning Important
For Travelgate billing adjustments, only external booking cancellations (processed directly with the Seller outside Travelgate) are considered. Only the cancellation status count is recalculated; amounts, fees, and other data are ignored.
:::
