...
The `data` field in `groupBy` allows you to group results by any of the following dimensions:
...
| `OPERATION_TYPE` | Group by the booking flow step (`SEARCH`, `QUOTE`, `BOOK`, `CANCEL`, `OTHER`) |
