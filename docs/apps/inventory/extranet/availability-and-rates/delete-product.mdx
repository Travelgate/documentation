...
In order to delete the availability conditions and prices loaded in Inventory for a specific hotel, you will need to go to the `Product` tab and then select the `Delete Product` option in the Inventory extranet.
