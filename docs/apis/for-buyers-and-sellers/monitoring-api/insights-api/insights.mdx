...
If you need to fetch a dynamic list of valid values to populate your Insights filters, use the following equivalence table to find them via the [Admin API](https://docs.travelgate.com/docs/apis/for-buyers-and-sellers/admin-api/overview):
