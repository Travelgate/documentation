...
![Channel-X Overview](../../../../static/img/docs/channel-x/channel-x_overview.svg)
...
- Don't forget to perform the [SetUp in the Inventory Tool](./inventory-tool/inventory-tool.mdx) before proceeding with your first [Full Copy](./fullcopy-and-deltas/fullcopy-and-deltas.mdx)!
