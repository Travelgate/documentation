...
The [AccumulativeDestination](/docs/apis/for-sellers/connectors-pull-developers-api/api-reference/accumulativedestination) object represents the standardized structure of the mapped destination element.
