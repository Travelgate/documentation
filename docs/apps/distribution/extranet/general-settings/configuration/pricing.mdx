...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing1.jpg)
...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing2.jpg)
...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing3.jpg)

This rule is related to the *base commission-markup* and the result of applying the [Selling Pricing Rules](#). With this rule it can be defined if the base commission-markup has always to be included on the selling price calculation or not. There are two modes of operation:
...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing4.jpg)

This rule is related to the total commission-markup obtained as result of applying all the [Selling Pricing Rules](#). This rule is not related to the base commission-markup and has no effect on it neither contemplates its value.
...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing5.jpg)
...
![Distribution Pricing](https://storage.travelgate.com/docs/distribution_configuration-pricing6.jpg)
