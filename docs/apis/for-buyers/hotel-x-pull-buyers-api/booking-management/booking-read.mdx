...
import {
  bookingQuery,
  bookingByBookingIDVariables,
  bookingByReferenceVariables,
  bookingByArrivalDatesVariables,
  bookingByBookingDatesVariables,
  bookingByDatesAggregatedVariables,
} from "../../../../../src/graphql/hotel-x/booking.read.query";
...
<GraphqlSample
  query={bookingQuery}
  variables={bookingByArrivalDatesVariables}
/>
...
<GraphqlSample
  query={bookingQuery}
  variables={bookingByBookingDatesVariables}
/>

#### Booking list by dates for multiple suppliers

You can generate a booking list based on booking or arrival dates by simply specifying your client (and deleting the access). This will provide a consolidated booking list from all suppliers associated with that client.

<GraphqlSample query={bookingQuery} variables={bookingByDatesAggregatedVariables} />
