...
![Template Structure Models Destinations](/img/docs/connectors-pull-developers-api/TemplateStructureModelsDestinations.png)
...
![TryValidateDestinations](/img/docs/connectors-pull-developers-api/DestinationsOperation.png)
...
![Build Request Destinations](/img/docs/connectors-pull-developers-api/DestinationsBuildRequest.png)
...
![Build Buyer's Response](/img/docs/connectors-pull-developers-api/DestinationsParseResponse.png)
           ...
           _accumulator.AddValue(new AccumulativeDestination()
            {
                ...
                {
                    { Iso2LanguageEnum.EN, destination.Name }
                }
            });
        }
    }
