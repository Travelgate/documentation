            ...
            <request>
                ...
                <AvailStatusMessages HotelCode="2" xmlns="http://www.opentravel.org/OTA/2003/05">
                    ...
                    <AvailStatusMessage BookingLimit="20">
                        ...
                        <LengthsOfStay FixedPatternLength="8" ArrivalDateBased="true">
                            <LengthOfStay MinMaxMessageType="FullPatternLOS">
                                <LOS_Pattern FullPatternLOS="00101011"></LOS_Pattern>
                            </LengthOfStay>
                        </LengthsOfStay>
...
#### **Fixed Pattern Length of Stay (FPLOS)**

The FPLOS functionality allows defining which stay durations are available for booking on specific dates using a binary pattern. FPLOS restrictions are always **arrival date based**, meaning the pattern is evaluated only on the check-in day (equivalent to `ArrivalDateBased="true"`).
...
|-----------|-------------|
| `FixedPatternLength` | Total number of days for which LOS restrictions apply. |
| `FullPatternLOS` | Binary pattern where each position represents a stay length: `1` = available, `0` = not available. |

**Example: Pattern `00101011`**

| Stay Length | Available |
|-------------|-----------|
| 1 Night     | ❌ No     |
| 2 Nights    | ❌ No     |
| 3 Nights    | ✅ Yes    |
