...
The Mapping plugin allows Buyers to perform the entire booking flow using their own hotel, board, room, and rate codes instead of the standard FastX codes or the supplier’s native codes.
...
* The supplier’s native information.
