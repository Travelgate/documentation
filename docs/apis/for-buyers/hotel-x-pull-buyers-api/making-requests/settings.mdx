...
To understand how Sellers assign these statuses and what each means for your booking flow, see [FastX Codes](/kb/platform/app-features/connections/fastx-codes).
