...
The `Search` operation is the entry point in the booking flow, enabling clients to retrieve available options based on their specific requirements. It allows buyers to query for availability, pricing, and other relevant details about accommodations offered by the supplier.
...
- [Helpers for Mapping Supplier Data](./../tools-and-helpers/policies-helpers/policies-helpers.mdx)
