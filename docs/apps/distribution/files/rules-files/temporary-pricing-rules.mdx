...
* **Delimiter:** Hashtag (`#`)
* **Data:**
   * **For All or Specific Agencies (mandatory)**: Defines if the rule is applicable to a list of specific agencies or if it applies to all agencies.
      * **`0`**: All agencies.
   ...
   * **Rate Type (mandatory)**: 
      ...
      * **`1`**: Only B2C.
      * **`2`**: Only B2B.
   * **For All, Direct, Third Party or Concrete providers (mandatory)**: Defines if the rule is applicable to a list of specific providers or if it applies to all providers or only to direct or third party providers. 
      * **`0`**: All providers.
   ...
   * **For All or a List of Concrete Hotels (and from countries, cities, chains or destinations) (mandatory)**: Defines if the rule is applicable to a list of specific hotels (and from countries, cities, chains or destinations) or if it applies to all hotels. 
      * **`0`**: All hotels.
   ...
   * **For All or a List of Concrete Markets (mandatory)**: Defines if the rule is applicable to a specific a list of markets or if it applies to all markets. 
      * **`0`**: All markets.
   ...
   * **For All or Concrete Meal Plans (mandatory)**: Defines if the rule is specific to a list of meal plans or if it applies to all meal plans.
      * **`0`**: All meal plans.
   ...
   * **For Any or Concrete Check-in Dates (mandatory)**: Defines if the rule is specific to a range of check-in dates or if it applies to any date.
   ...
   * **For Any or Concrete Booking Dates (mandatory)**: Defines if the rule is specific to a range of booking dates or if it applies to any date.
      * **`0`**: All booking dates.
   ...
   * **For Any or Concrete Range of Prices (mandatory)**: Defines if the rule is specific to a range of prices or if it applies to any price.
      * **`0`**: All prices.
   ...
   * **For Any or Concrete Range of Release from check-in**: Defines if the rule is applicable to a specific range of days of release from check-in or if it applies to any release.
   ...
   * **For Any or Concrete Range of Hours**: Defines if the rule is applicable to a specific range of hours or if it applies to any hour.
