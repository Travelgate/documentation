...
This operation is designed for the comprehensive retrieval of full **HotelList** static data. This operation should be used when all hotel information can be retrieved at once.
