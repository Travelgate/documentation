...
![Template Structure Models Rooms](/img/docs/connectors-pull-developers-api/TemplateStructureModelsRooms.png)
...
![TryValidateRooms](/img/docs/connectors-pull-developers-api/RoomsOperation.png)
...
![Build Request Rooms](/img/docs/connectors-pull-developers-api/RoomsBuildRequest.png)
...
![Build Buyer's Response](/img/docs/connectors-pull-developers-api/RoomsParseResponse.png)
