...
/* harmony import */ var graphql_language_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(82210);
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("hint", "graphql", (editor, options) => {
  ...
  const position = new graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .Position */ .yX(cur.line, tokenStart);
  const rawResults = (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .getAutocompleteSuggestions */ .CE)(schema, editor.getValue(), position, token, externalFragments, autocompleteOptions);
  const results = {
...
(function(module, exports) {
  (function(mod) {
    mod((0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.r)());
  })(function(CodeMirror) {
...
const showHint = /* @__PURE__ */ (0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.g)(showHintExports);
