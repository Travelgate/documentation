...
- **Purpose**: RuntimeConfiguration defines key parameters of the integration. These parameters will appear in the web access interface to be filled in, and their values can be either mandatory or optional. Here are some examples of possible parameters:
  - User.
  - Password.
...
| ------- | --- | ---- | ----------- |
| Parameters | N | Parameters | Gets or sets the parameters list. |
<!-- TABLE END -->
