...
- **Web Logs:** If the issue occurs on your portal, follow the steps in our Knowledge Base to [retrieve web logs](/kb/platform/support-portal/how-to-retrieve-web-logs-from-portal).  
