...
Define the responses for your quote operation, it is recommended to insert a supplier response into every mock or at least, into the mocks of the operation you will be developing.
...
**Example of a QuoteRequest model** (File: QuoteRequest.cs):
...
**Example of a QuoteResponse model** (File: QuoteResponse.cs):
...
- Object of the requests previously created (QuoteRequest)
