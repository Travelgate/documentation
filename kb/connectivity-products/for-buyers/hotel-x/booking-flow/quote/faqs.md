...
If the Seller provides this information, you can obtain the supplier's room code by including the `rooms` node in the `HotelOptionQuote` node.  You will also receive the FastX standarized room code and room description.
