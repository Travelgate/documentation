...
| **Accommodations/Boards/Options/**<br />**Rooms/CancelPolicy/**<br />**CancelPenalties/HoursBefore** | 0 . . 1 | Integer | Indicates the number of hours before the check-in date when the penalty becomes applicable. |
...
| **Accommodations/Boards/Options/**<br />**CancelPolicy/CancelPenalties/**<br />**HoursBefore** | 0 . . 1 | Integer | Indicates the number of hours before the check-in date when the penalty becomes applicable. |
