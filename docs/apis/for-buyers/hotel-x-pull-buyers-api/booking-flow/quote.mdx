...
* **Cancellation Policies:** In the `cancelPolicy` response structure, you’ll find a `refundable` field. If this field is set to **"false"**, it means the room is **non-refundable** (100% cancellation cost applies).
...
<details>
    <summary>Are there any limitations on the number of HotelX Quote requests allowed per minute?</summary>
    <div>
