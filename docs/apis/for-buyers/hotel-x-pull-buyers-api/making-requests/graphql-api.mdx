...
HotelX is a travel API based on GraphQL. Unlike XML Soap APIs, GraphQL allows to request and receive only the necessary data. Our Gateway, written in NodeJS, is the sole endpoint for all our APIs.

### Why GraphQL?

Travelgate's GraphQL API provides a flexible and efficient approach to data access, enabling clients to query exactly the data they need, when they need it. It’s ideal for partners looking to build modern, high-performance travel integrations with full control over their data interactions.
...
By leveraging these resources, you can become proficient in GraphQL and make the most of our HotelX Pull Buyers API.