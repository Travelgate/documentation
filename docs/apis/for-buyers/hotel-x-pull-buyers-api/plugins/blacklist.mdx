...
| Block a hotel code using the supplier codes                   | 📄[blacklist\_access\_hotels.csv](#) |
| Block all hotel codes from any supplier except some specified | 📄[blacklist\_access\_hotels.csv](#) |
...
Once you've uploaded your blacklist file, you can use the plugin adding the following field to the `settings` node of your request:
