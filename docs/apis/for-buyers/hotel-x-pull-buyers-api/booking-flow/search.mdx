...
Remember to upload your [mapping files](../plugins/overview.md) to your FTP account in those cases you run requests with your own context codes, this way you will receive results from all your Sellers with your own hotel codes.
...
* `plugin`: You can filter and specify which [plugins](../plugins/overview.md) need to be included or excluded.
