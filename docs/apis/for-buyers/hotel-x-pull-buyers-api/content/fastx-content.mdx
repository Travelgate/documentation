...
As a Buyer, you can map to the FastX code set once and use it across eligible content from connected Suppliers, subject to connection status, portfolio configuration, mapping status, search criteria, and availability.
