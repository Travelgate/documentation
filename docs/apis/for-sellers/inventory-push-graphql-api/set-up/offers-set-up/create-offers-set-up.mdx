...
With the following mutation, we are going to create a new offer available for all rooms linked to a rate that gives away the cheapest night of the booking if the length of stay of the reservation is at least a week.
