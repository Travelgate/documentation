...
<Tabs>
  <TabItem value="Criteria" label="C# Criteria" default>
    ```csharp
using System;
using System.ComponentModel.DataAnnotations;
using System.Runtime.Serialization;
using Connectors.Core.Application.Helpers;
...
using Connectors.Pull.Hotel.Domain.Contracts.Search.Request;
...
/// <see cref="SearchCriteria"/>, <see cref="QuoteCriteria"/>, and <see cref="BookCriteria"/>.
/// It includes common fields such as check-in and check-out dates, language preferences,
/// currency, and nationality.
/// </remarks>
[DataContract]
[KnownType(typeof(SearchCriteria))]
[ProtoInclude(20, typeof(SearchCriteria))]
[KnownType(typeof(QuoteCriteria))]
[ProtoInclude(40, typeof(QuoteCriteria))]
[KnownType(typeof(BookCriteria))]
[ProtoInclude(60, typeof(BookCriteria))]
...
public class Criteria
{
        ...
        /// Use <see cref="CheckInAsDateTime"/> to access the parsed DateTime representation.
        /// </remarks>
        [DataMember(Order = 1)]
        [Required]
        ...
        /// Use <see cref="CheckOutAsDateTime"/> to access the parsed DateTime representation.
        /// </remarks>
        [DataMember(Order = 2)]
        [Required]
        ...
        /// <summary>
        /// The check-in date parsed as a <see cref="DateTime"/> object.
        /// </summary>
        /// <remarks>
        /// This property leverages <see cref="DateTimeHelper.GetOrParse(ref DateTime?, string)"/> for parsing the string value
        /// of <see cref="CheckIn"/>. Use this to perform date-related operations.
        /// </remarks>
        public DateTime CheckInAsDateTime => DateTimeHelper.GetOrParse(ref _checkIn, CheckIn);

        private DateTime? _checkOut;
        /// <summary>
        /// The check-out date parsed as a <see cref="DateTime"/> object.
        /// </summary>
        /// <remarks>
        /// Similar to <see cref="CheckInAsDateTime"/>, this property parses <see cref="CheckOut"/>
        /// to provide a strongly typed representation of the check-out date.
        /// </remarks>
        public DateTime CheckOutAsDateTime => DateTimeHelper.GetOrParse(ref _checkOut, CheckOut);

        private uint? _nights;
        /// <summary>
        /// The total number of nights for the stay, calculated as the difference between check-in and check-out dates.
        /// </summary>
        /// <remarks>
        /// The value is computed using <see cref="DateTimeHelper.GetOrParse(ref DateTime?, string)"/> and assumes valid input
        /// for <see cref="CheckIn"/> and <see cref="CheckOut"/>.
        /// </remarks>
        [PublicAPI]
        public uint TotalNights => DateTimeHelper.GetOrParse(ref _nights, CheckInAsDateTime, CheckOutAsDateTime);
        ...
        /// <summary>
        /// The preferred currency for the operation, defined as an optional <see cref="Currency"/> value.
        /// </summary>
        /// <remarks>
...
```
  ...
  <TabItem value="SearchCriteria" label="C# SearchCriteria">
    ```csharp
...
/// Inherits from <see cref="Criteria"/>.
/// </summary>
[DataContract]
public class SearchCriteria : Criteria
{
        ...
        /// It must conform to the <see cref="Destinations"/> validation attributes.
        /// </remarks>
        [DataMember(Order = 1)]
        [Destinations]
        [Required]
        public Destinations Destinations { get; init; }
        ...
        /// This property is required and must conform to the <see cref="Occupancy"/> validation attributes.
        /// </remarks>
        [DataMember(Order = 2)]
        [Occupancy]
        [Required]
        public IEnumerable<Occupancy> Occupancies { get; init; }
        ...
        /// <summary>
        /// Sets new destinations for the search criteria. 
        /// Updates the list of accommodations in the <see cref="Destinations"/> property.
        /// </summary>
        /// <param name="accs">The new accommodations to set.</param>
        internal void SetNewDestinations(IEnumerable<AccommodationRQ> accs)
        {
                Destinations.Accommodations = accs;
        }
}
    ```
  </TabItem>
...
<Tabs>
  <TabItem value="SearchRs" label="C# SearchRs" default>
    ```csharp
using System;
using System.Collections.Generic;
using System.Runtime.Serialization;
using Connectors.Core.Domain.AdviseMessages;
using Connectors.Core.Domain.ProviderAudit;
using Connectors.Pull.Hotel.Domain.Contracts.Common;
...
/// Additionally, it includes error or warning messages (<see cref="AdviseMessages"/>) and trace data (<see cref="AuditData"/>),
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SearchRs"/> class.
    /// This constructor is private and used internally for serialization purposes.
    /// </summary>
    private SearchRs()
    {
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SearchRs"/> class with the specified accommodations and optional advise messages.
    /// </summary>
    /// <param name="accommodations">The list of accommodations found in the search.</param>
    /// <param name="adviseMessages">
    /// Optional collection of <see cref="AdviseMessage"/> instances that provide warnings or errors related to the search operation.
    /// </param>
    public SearchRs(List<Accommodation> accommodations, IEnumerable<AdviseMessage> adviseMessages = null)
    {
        Accommodations = accommodations;
        AdviseMessages = adviseMessages;
    }
    ...
    /// </summary>
    [DataMember(Order = 2)]
    public IEnumerable<AdviseMessage> AdviseMessages { get; init; }
    ...
    /// </summary>
    [DataMember(Order = 3)]
    public List<Accommodation> Accommodations { get; init; }
    ...
    /// <summary>
    /// Discarded items in the search response, can be rooms or options depending on the connector.
    /// </summary>
    [DataMember(Order = 5)]
    ...
    /// </summary>
    /// <param name="adviseMessages">
    /// A collection of <see cref="AdviseMessage"/> instances that describe the error or warnings encountered during the operation.
    /// </param>
    /// <returns>
    /// A new instance of <see cref="SearchRs"/> configured as an error response.
    /// </returns>
    public static SearchRs BuildErrorResponse(IEnumerable<AdviseMessage> adviseMessages)
    {
        return new SearchRs(null, adviseMessages);
    }

    /// <summary>
    /// Builds an error response containing a single advise message.
    /// </summary>
    /// <param name="adviseMessage">
    /// A single <see cref="AdviseMessage"/> instance describing the error or warning encountered during the operation.
    /// </param>
    /// <returns>
    /// A new instance of <see cref="SearchRs"/> configured as an error response.
    /// </returns>
    ...
    {
        return new SearchRs(null, [adviseMessage]);
    }
}
```
  </TabItem>
  <TabItem value="SampleJsonResponse" label="Connector Sample JSON">
    ```json
{
    "adviseMessages":
    [
