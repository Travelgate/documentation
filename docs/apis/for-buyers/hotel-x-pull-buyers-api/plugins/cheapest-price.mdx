...
- **If you use HotelX in multimode** (multiple suppliers at once), make sure to **map hotel codes and other entities**. This allows us to group and compare options correctly.  
