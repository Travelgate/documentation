...
| ValuationRQ/OnRequest                              | 1          | Boolean  | Indicates if you want to receive the on request selected option in ValuationRS, as long as the supplier returns it in this method (see [MetaData](../content/meta-data/)). |
...
| CancelPenalty/Deadline    | 1          | String   | Date on UTC Standard TimeZone in which this Cancellation policy applies (ISO 8601 e.g: 2016-07-01T05:00:00Z). Cancellation fees will be applied between this date and check-in date.  |
